...
### Evaluation
You can follow the instructions in the [script](https://github.com/The-FinAI/PIXIU/blob/ijcai_challenge/Finarg-ecc-auc%2BEdtsum_evaluation_sample.ipynb) to do evaluations on Task 1: financial classification.
