...
python src/eval.py \
    ...
    --model_args use_accelerate=True,pretrained=ChanceFocus/finma-7b-nlp,tokenizer=ChanceFocus/finma-30b-nlp,use_fast=False,max_gen_toks=16,dtype=float16 \
    --no_cache \
    --batch_size 2 \
...
python src/eval.py \
    ...
    --model_args use_accelerate=True,pretrained=ChanceFocus/finma-30b-nlp,tokenizer=ChanceFocus/finma-30b-nlp,use_fast=False,max_gen_toks=256,dtype=float16 \
    --no_cache \
    --batch_size 2 \
    --model_prompt 'finma_prompt' \
    --num_fewshot 0 \
...
python src/eval.py \
    --model hf-causal-llama \
    --tasks flare_edtsum \
    --model_args use_accelerate=True,pretrained=ChanceFocus/finma-30b-nlp,tokenizer=ChanceFocus/finma-30b-nlp,use_fast=False,max_gen_toks=512,dtype=float16 \
    --no_cache \
    --batch_size 2 \
    --model_prompt 'finma_prompt' \
    --num_fewshot 0 \
